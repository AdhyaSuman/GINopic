...
from octis.models.BAT_model.models.BATM import BATM


class BAT(AbstractModel):
    ...
    def train_model(self, dataset, hyperparameters=None, top_words=10):
        ...
        if self.use_partitions and not self.use_validation:
            ...
            self.model = BATM(bow_dim=input_size,
    ...
    def get_info(self):
        ...
        with torch.no_grad():
            ...
            info['topic-word-matrix'] = self.model.generator.inference(idxes).cpu().numpy()

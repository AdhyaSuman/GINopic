...
class ETM(BaseETM):
    ...
    def __init__(self, num_topics=10, num_epochs=100, t_hidden_size=800, rho_size=300, embedding_size=300,
                 ...
                 embeddings_type='pickle', binary_embeddings=True, headerless_embeddings=False,
    ...
    def set_model(self, dataset, hyperparameters):
        if self.use_partitions and self.use_validation:
            ...
            self.train_tokens, self.train_counts, \
            self.test_tokens, self.test_counts = self.preprocess(vocab2id, data_corpus_train, data_corpus_test)

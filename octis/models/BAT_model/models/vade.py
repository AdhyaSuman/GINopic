...
class VaDE(nn.Module):
    def __init__(self, encode_dims=[2000,1024,512,20],decode_dims=[20,1024,2000],dropout=0.0,n_clusters=10,nonlin='relu'):
        ...
        self.gmm = GaussianMixture(n_components=self.n_clusters, covariance_type='diag', max_iter=200, reg_covar=.1)
    ...
    def log_pdfs_gauss(self,z,mus,logvars):
        ...
        log_pdfs = []
        # print('z.dim', z.shape)
        # print('mus.dim', mus.shape)
        # print('logvars.dim', logvars.shape)
    ...
    def gmm_kl_div(self,mus,logvars):
        ...
        # print('z.dim', zs.shape)
        # print('mu_c.dim', mu_c.shape)
        # print('logvar_c.dim', logvar_c.shape)

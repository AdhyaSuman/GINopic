...
class ProdLDA(AVITM):
    def __init__(self, num_topics=10, activation='softplus', dropout=0.2, learn_priors=True, batch_size=64, lr=2e-3,
                 ...
                 prior_variance=None, num_layers=2, num_neurons=100, num_samples=10, use_partitions=True, use_validation=False):
        super().__init__(num_topics=num_topics, model_type='prodLDA', activation=activation, dropout=dropout,
                         ...
                         num_neurons=num_neurons, num_samples=num_samples, use_partitions=use_partitions, use_validation=use_validation)
